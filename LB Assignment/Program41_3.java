/*
    Accept two arrays from user and display odd contents of arrays
...
class Arithmetic extends ArrayX
{
    ...
    {
        System.out.println("Odd elements of "+str+" array are:");
        for(int iCnt = 0; iCnt < array.length; ++iCnt)
        {
            if((array[iCnt] % 2) != 0)
                System.out.print(array[iCnt]+"\t");
...
class Program41_3
{
    public static void main(String a[])
    {
        ...
        first_array.displayOdd();
        second_array.displayOdd();
    }
}